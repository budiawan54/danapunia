...
<head>
  ...
  <!-- Libraries CSS Files -->
  <link href="library/nivo-slider/css/nivo-slider.css" rel="stylesheet">
  <link href="library/owlcarousel/owl.carousel.css" rel="stylesheet">
  <link href="library/owlcarousel/owl.transitions.css" rel="stylesheet">
  <link href="library/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <link href="library/animate/animate.min.css" rel="stylesheet">
  <link href="library/venobox/venobox.css" rel="stylesheet">

  <!-- Nivo Slider Theme -->
  <link href="cess/nivo-slider-theme.css" rel="stylesheet">

  <!-- Main Stylesheet File -->
  <link href="cess/style.css" rel="stylesheet">

  <!-- Responsive Stylesheet File -->
  <link href="cess/responsive.css" rel="stylesheet">
...
<body data-spy="scroll" data-target="#navbar-example">
            ...
            <nav class="navbar navbar-default">
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
                  <li>
                    <a class="page-scroll" href="#home"><i class="fa fa-undo"></i> Halaman Beranda</a>
                  </li>
                  <li>
                    <a class="page-scroll" href="#home"><i class="fa fa-undo"></i> Halaman Blog</a>
                  </li>
                  <li>
                    <a class="page-scroll">Masuk <i class="fa fa-sign-in"></i></a>
                  </li>
                </ul>
              </div>
              <!-- navbar-collapse -->
            ...
            <div class="footer-content">
              <div class="footer-head">
                <div class="footer-logo">
                  <img src="img/team/1.jpg" style="width: 60px; height: 60px">
                </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="footer-content">
              <div class="footer-head">
                <h4>information</h4>
                <p>
                  Untuk yang membutuhkan informasi tambahan silakan bisa menghubungi daftar kontak yang tersedia di bawah ini.
                </p>
                <div class="footer-contacts">
                  <p><span>Telp/Whatsapp:</span> +123 456 789</p>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="copyright text-center">
              <p>
                &copy; Hak Cipta <strong>SD Dana Punia Singaraja</strong>. All Rights Reserved
              </p>
            </div>
          </div>
        </div>
  ...
  <script src="library/venobox/venobox.min.js"></script>
  <script src="library/knob/jquery.knob.js"></script>
  <script src="library/wow/wow.min.js"></script>
  <script src="library/parallax/parallax.js"></script>
  <script src="library/easing/easing.min.js"></script>
  <script src="library/nivo-slider/js/jquery.nivo.slider.js" type="text/javascript"></script>
  <script src="library/appear/jquery.appear.js"></script>
